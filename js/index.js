        ...
        series: [
            {
                name: "新增粉丝",
                type: "line",
                data: [24, 40, 101, 134, 90, 230, 210, 230, 120, 210, 120],
                smooth: true
            },
            {
                name: "新增游客",
                type: "line",
                data: [40, 64, 191, 324, 290, 330, 213, 180, 200, 180, 79],
                smooth: true
            }
        ]
    }
        ...
        series: [
            {
                ...
                type: "line",
                data: [24, 40, 101, 134, 90, 230, 210, 230, 120, 210, 120,
                    24, 40, 101, 134, 90, 230, 210, 230, 120, 210, 120,
            ...
            },
            {
                ...
                type: "line",
                data: [40, 64, 191, 324, 290, 330, 213, 180, 200, 180, 79,
                    40, 64, 191, 324, 290, 330, 213, 180, 200, 180, 79,
                    40, 64, 191, 324, 290, 330, 213, 180],
                smooth: true,
                areaStyle: {
                    color: new echarts.graphic.LinearGradient(
                        0,0,0,1,
...
(function () {
    ...
    var option = {
        color: ["#006cff", "#60csa0", "ed8884", "#ff9f7f", "#0096ff",
                "#9fe6b8", "#32c5e9", "#1d9dff"],
        tooltip: {
            trigger: 'item',
            formatter: "{a} <br/>{b}:{c} ({d}%)"
        },
